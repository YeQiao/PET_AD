...
def get_model(**kwargs):
    ...
    Returns the model.
    """
    model = eEEGNet(**kwargs)
    return model


if __name__ == "__main__":
    model = get_model(num_classes=600, sample_size=112, width_mult=1., model_name = 'V1')
    model = model.cuda()
