...
def Cifar10DataLoader(batch_size = 256):
    ...
    image_datasets = {}
    image_datasets['train'] = dset.CIFAR10(root='./', train=True, download=True, transform=data_transforms['train'])
    image_datasets['val'] = dset.CIFAR10(root='./', train=False, download=True, transform=data_transforms['val'])
